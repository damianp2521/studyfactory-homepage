...
export const reviews: Review[] = [
  {
    ...
    content: "Study Factory의 최대 장점은 사장님의 상주입니다. 흐트러질 틈 없는 긴장감 속에서 공부할 수 있었고, 중간중간 해주시는 멘탈 케어가 큰 힘이 되었습니다. 특히 아침마다 자리에 가져다주시는 미숫가루와 커피, 꽉 채워진 간식 덕분에 오직 공부에만 집중할 수 있는 환경입니다.",
    rating: 5,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    name: "joj****",
    role: "전문직 & 지방 수험생 추천",
    summary: "서울 갈 돈 아껴서 Study Factory 등록하세요. 그게 합격의 지름길입니다.",
  ...
  },
  {
    ...
    name: "둥****",
    role: "전문직 생동차 합격",
    summary: "억만장자도 못 사는 '시간', Study Factory에서는 살 수 있습니다.",
